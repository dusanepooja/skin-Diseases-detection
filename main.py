...
# Create widgets
label = tk.Label(root, text="Select an image of a skin lesion:", font=("Arial", 14), bg="#f0f0f0", fg="#333")
label.pack(pady=10)
...
result_label = tk.Label(root, text="", font=("Arial", 14), fg="#333", bg="#f0f0f0")
